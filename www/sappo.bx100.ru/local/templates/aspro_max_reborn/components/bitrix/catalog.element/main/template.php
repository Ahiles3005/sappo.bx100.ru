            ...
            <div class="info_item hidden-md hidden-lg">
                ...
                <?if($arResult['HELP_TEXT']):?>
                    ...
                    <div class="text-form">
                        ...
                        <?php if($arResult['PROPERTIES']['SEZONNYY_TOVAR']['VALUE'] == 'Y'):?>
                            <div class="price_txt muted777 font_sxs muted ncolor">
                                <?=CMax::showIconSvg("info_big pull-left", SITE_TEMPLATE_PATH.'/images/svg/catalog/info_big.svg', '', '', true, false);?>
                                <div class="text-form-info">
                                    Температурный режим не ниже +5 °С
                                </div>
                            </div>
                        <?php endif;?>
                        <?php if($arResult['PROPERTIES']['TEPLAYA_DOSTAVKA']['VALUE'] == 'Да'):?>
                            <div class="price_txt muted777 font_sxs ncolor">
                                <?=CMax::showIconSvg("info_big pull-left", SITE_TEMPLATE_PATH.'/images/svg/catalog/snowflake_b.svg', '', '', true, false);?>
                                <div class="text-form-info">
                                    <span class="dotted">Температурный режим</span> не ниже +5 °С
                                </div>
                            </div>
                            <div id="warm_delivery" style="display: none">
                                <div class="warm_delivery_info_overlay"></div>
                                <div class="dyn_mp_jqm_frame jqmWindow popup jqm-init MAIN scrollblock show warm_delivery mini">
                                    <div class="form marketing-popup popup-text-info .default ">
                                        <a href="#" class="close jqmClose">
                                            <?=CMax::showIconSvg('', SITE_TEMPLATE_PATH.'/images/svg/Close.svg')?>
                                        </a>
                                        <div class="popup-text-info__title font_exlg darken option-font-bold">Теплая доставка!</div>
                                        <div class="popup-text-info__text font_sm">
                                            <p>Отметка «Температурный режим» — означает, что в зимний период данные товары необходимо транспортировать и хранить только в <b>температурном диапазоне от +5 °С до +25 °С</b>, иначе мы не сможем гарантировать сохранность всех рабочих свойств.</p>
                                            <div class="popup-text-info__btn">
                                                <a class="btn btn-default btn-lg ok" href="#">Прекрасно</a>
                                                <a class="btn btn-transparent-border-color btn-lg has-ripple" href="/help/delivery/#warm_delivery">Хочу подробностей</a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <script>
                                ...
                                $('.warm_delivery a.close, .warm_delivery .popup-text-info__btn .ok').on('click', function (e) {
                                    e.preventDefault();
                ...
                <div class="main_item_wrapper js-offers-calc product-action">
                                        ...
                                        <div class="price_group min">
                                            <div class="price_matrix_wrapper">
                                                <div class="prices-wrapper">
                                                    <div class="price font-bold font_mlg font_mxs" data-currency="" data-value="">
                                                        <span class="values_wrapper">
                                                            <span class="price_value"><?= $basePrice?></span>
                                                            <span class="price_currency"> ₽</span>
                                                        </span>
                                                    </div>
                                                    <div class="price discount" data-currency="" data-value="">
                                                    ...
                                                    <div class="sale_wrapper font_xxs">
                                                        ...
                                                        <div class="sale-number rounded2">
                                                            ...
                                                            <div class="inner-sale rounded1">
                                                                <div class="text">Экономия <span class="values_wrapper"><span class="price_value"><?=$ecoP?></span><span class="price_currency"> ₽</span></span></div>
                                                            </div>
                                                        </div>
                    ...
                    $bonusesSum = $catalog->calculateBonus([ ['ID'=>$arResult['ID'], 'PRICE'=>$basePrice] ]);
                                ...
                                <div class="counter_wrapp list big clearfix">
                                    ...
                                    <?if(is_array($arParams) && $arParams):?>
                                        ...
                                        <?if(($arAddToBasketData["OPTIONS"]["USE_PRODUCT_QUANTITY_LIST"] && $arAddToBasketData["ACTION"] == "ADD") && $arAddToBasketData["CAN_BUY"]):?>
                                            ...
                                            <?endif;?>
                                            <div class="counter_block md<?=$class;?>" data-item="<?=$arResult["ID"];?>">
                                                <?$cntBasketItems = CSaleBasket::GetList(
                                                    array("NAME" => "ASC", "ID" => "ASC"),
                                                    array("PRODUCT_ID" => $arResult["ID"], "FUSER_ID" => CSaleBasket::GetBasketUserID(), "LID" => SITE_ID, "ORDER_ID" => "NULL"),
                                                    false,
                                                    false,
                                                    array("QUANTITY")
                                                )->Fetch();
                                                ...
                                                <input type="text" class="text" id="<? echo $arItemIDs["ALL_ITEM_IDS"]['QUANTITY']; ?>" name="<?=$arParams["PRODUCT_QUANTITY_VARIABLE"]; ?>" value="<?=floatval($cntBasketItems['QUANTITY']) ? floatval($cntBasketItems['QUANTITY']) : 1?>" />
                                        ...
                                        foreach(GetModuleEvents(\CMax::moduleID, 'OnAsproShowItemCounter', true) as $arEvent) // event for manipulation item delay and compare buttons
                                            ExecuteModuleEventEx($arEvent, array($arAddToBasketData, $arResult, $arItemIDs, $arParams, &$html));
                        ...
                        <div class="brand-detail-info bordered rounded3">
                            ...
                            <div class="brand-detail-info__preview">
								<?php if ($arResult['SECTION']): ?>
                                    <div class="catalog-element-section-link">
                                        <a href="<?= $arResult['SECTION']['SECTION_PAGE_URL']; ?>"><?= Loc::getMessage('CATALOG_ELEMENT_SECTION_DETAIL_LINK_TEXT'); ?></a>
                                    </div>
                                <?php endif; ?>
                                <div class="catalog-element-brand-link">
                                    <a href="<?= $arResult['BRAND_ITEM']['DETAIL_PAGE_URL']; ?>"><?= Loc::getMessage('CATALOG_ELEMENT_BRAND_DETAIL_LINK_TEXT', ['#NAME#' => $arResult['BRAND_ITEM']['NAME']]); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
