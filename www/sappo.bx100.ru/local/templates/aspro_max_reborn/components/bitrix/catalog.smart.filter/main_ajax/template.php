...
if($arResult["ITEMS"]){?>
	...
	<div class="bx_filter bx_filter_vertical swipeignore <?=(isset($arResult['EMPTY_ITEMS']) ? 'empty-items': '');?>">
		<div class="slide-block">
			<div class="slide-block__head filter_title <?=($bActiveFilter && $bActiveFilter[1] != 'clear' ? 'active-filter' : '')?> title-menu font-bold colored_theme_hover_bg-block darken font_mlg" <?/*=($_COOKIE['FILTER_CLOSED'] == 'Y' ? ' closed' : '');*/?> data-id="FILTER">
				<?=CMax::showIconSvg("catalog", SITE_TEMPLATE_PATH.'/images/svg/catalog/sappo_filter.svg', '', '', true, false);?>
							...
							<div class="bx_filter_button_box btns ajax-btns">
								<div class="bx_filter_block">
									<div class="bx_filter_parameters_box_container">
										...
										<button class="bx_filter_search_reset btn btn-default btn-transparent round-ignore<?=($bActiveFilter && $bActiveFilter[1] != 'clear' ? '' : ' disabled');?> pull-left" type="reset" id="del_filter" name="del_filter" data-href="" title="<?=Loc::getMessage("CT_BCSF_DEL_FILTER")?>">
											<!-- <?=CMax::showIconSvg("reset", SITE_TEMPLATE_PATH.'/images/svg/catalog/cleanfilters_big.svg', '', '', true, false);?> --> Сбросить
										</button>
									</div>
								</div>
							</div>
