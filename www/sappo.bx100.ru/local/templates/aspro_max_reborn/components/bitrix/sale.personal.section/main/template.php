		...
		<div class="row sale-personal-section-row-flex">
            <?/*?><div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="promo-block">
                    <div class="coins">
                        <div class="coin">
                            <img src="/local/templates/aspro_max_reborn/images/sappo-bonus-coin.png">
                        </div>
                    </div>
                    <div class="promo-content">
                        <h1>Рекомендуйте нас друзьям</h1>
                        <p class="promo-content-text">
                            Отправляйте друзьям этот промокод, они получат 500 рублей на первую покупку,
                            а вы 500 рублей за использование промокода.
                        </p>
                        <div class="promo-code">
                            <input type="text" value="MALYSHEV959" readonly>
                            <button class="copy-btn">
                                <img src="/local/templates/aspro_max_reborn/images/copy.png">
                            </button>
                        </div>
                        ...
                        <p class="info">Пожалуйста, не публикуйте промокод на сайты и в наших сообществах. В этом случае он может быть заблокирован.</p>
                    </div>
                </div>
            </div><?*/?>
