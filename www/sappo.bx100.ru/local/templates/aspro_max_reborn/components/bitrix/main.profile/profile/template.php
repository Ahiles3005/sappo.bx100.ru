	...
	<div class="form-block-wr">
		...
		<?else:?>
			<form method="post" name="form1" class="main" action="<?=$arResult["FORM_TARGET"]?>?" enctype="multipart/form-data">
                ...
                <input required type="hidden" name="PERSONAL_PHONE" class="phone" maxlength="255" value="<?=$arResult["arUser"]["PHONE_NUMBER"]?>" />
					...
					<div class="form-control">
						<div class="wrap_md">
							<div class="iblock label_block">
								...
								?>
								<input <?=($arResult['PHONE_REQUIRED'] ? 'required' : '')?> type="tel" name="PHONE_NUMBER" class="phone" maxlength="255" required value="<?=$arResult["arUser"]["PHONE_NUMBER"]?>" />
							</div>
							<div class="iblock text_block">
