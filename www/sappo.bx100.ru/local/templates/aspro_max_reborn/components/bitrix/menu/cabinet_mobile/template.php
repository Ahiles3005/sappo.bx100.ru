				...
				<ul class="dropdown">
					...
					<?foreach($arResult as $arItem):?>
						...
						<li <?=($arItem['SELECTED'] ? 'class="selected"' : '')?> >
							<a class="dark-color<?=($bParent ? ' parent' : '')?>" href="<?=$arItem["LINK"]?>" title="<?= strip_tags($arItem["TEXT"]); ?>">
								...
								<ul class="dropdown">
									...
									<?foreach($arItem['CHILD'] as $arSubItem):?>
										...
										<li<?=($arSubItem['SELECTED'] ? ' class="selected"' : '')?>>
											<a class="dark-color<?=($bParent ? ' parent' : '')?>" href="<?=$arSubItem["LINK"]?>" title="<?=strip_tags($arSubItem["TEXT"]); ?>">
												...
												<ul class="dropdown">
													...
													<?foreach($arSubItem["CHILD"] as $arSubSubItem):?>
														...
														<li<?=($arSubSubItem['SELECTED'] ? ' class="selected"' : '')?>>
															<a class="dark-color<?=($bParent ? ' parent' : '')?>" href="<?=$arSubSubItem["LINK"]?>" title="<?=strip_tags($arSubSubItem["TEXT"]);?>">
																...
																<ul class="dropdown">
																	...
																	<?foreach($arSubSubItem["CHILD"] as $arSubSubSubItem):?>
																		<li<?=($arSubSubSubItem['SELECTED'] ? ' class="selected"' : '')?>>
																			<a class="dark-color<?=($bParent ? ' parent' : '')?>" href="<?=$arSubSubSubItem["LINK"]?>" title="<?=strip_tags($arSubSubSubItem["TEXT"]);?>">
