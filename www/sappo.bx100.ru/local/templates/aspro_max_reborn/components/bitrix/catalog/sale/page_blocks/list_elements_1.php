...
//Сортируем по региону
            ...
            <?$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "SECTION_ID" => (CSite::InDir('/catalog/sale/') ? 0 : $arResult["VARIABLES"]["SECTION_ID"]),
                    "SHOW_ALL_WO_SECTION" => (CSite::InDir('/catalog/sale/') ? "Y" : "N"),
                    "SECTION_CODE" => $arResult["VARIABLES"]["SECTION_CODE"],
                    "AJAX_REQUEST" => $isAjax,
                    "ELEMENT_SORT_FIELD" => "property_". $sortForRegion,
                    ...
                    "INCLUDE_SUBSECTIONS" => (CSite::InDir('/catalog/sale/') ? "Y" : $arParams["INCLUDE_SUBSECTIONS"]),
