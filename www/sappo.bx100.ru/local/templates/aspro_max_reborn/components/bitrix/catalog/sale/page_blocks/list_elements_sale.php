...
//Сортируем по региону
            ...
            <?php
            //$GLOBALS['saleFilter'] = array("PROPERTY_HIT_VALUE"=>"Акция");
            ?>
            <?$APPLICATION->IncludeComponent(
                ...
                Array(
                    ...
                    "INCLUDE_SUBSECTIONS" => /*(CSite::InDir('/catalog/sale/') ? "Y" : $arParams["INCLUDE_SUBSECTIONS"])*/'Y',
                    "PAGE_ELEMENT_COUNT" => /*$show*/25,
