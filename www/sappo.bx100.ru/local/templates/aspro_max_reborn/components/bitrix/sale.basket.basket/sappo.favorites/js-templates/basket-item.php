...
<script id="basket-item-template" type="text/html">
    <tr class="basket-items-list-item-container{{#SHOW_RESTORE}} basket-items-list-item-container-expend{{/SHOW_RESTORE}}{{#DELAYED}} delayed-item{{/DELAYED}}"
        id="basket-item-{{ID}}" data-entity="basket-item" data-id="{{ID}}" data-stock="{{OUT_OF_STOCK}}">
        {{#SHOW_RESTORE}}
        ...
        <td class="basket-items-list-item-descriptions">
            <div class="basket-items-list-item-descriptions-inner" id="basket-item-height-aligner-{{ID}}">
                ...
                <div class="basket-item-price-sbonus-mobile ">
                    <span class="sbonus-product"><span>+{{{BONUSES}}}</span></span>
                </div>
        ...
        if ($usePriceInAdditionalColumn)
        {
            ...
            <td class="basket-items-list-item-price basket-items-list-item-price-for-one<?=(!isset($mobileColumns['PRICE']) ? ' hidden-xs' : '')?>">
                <div class="basket-item-block-price">
                    ...
                    <div class="basket-item-price-sbonus">
                        <span class="sbonus-product"><span>+{{{BONUSES}}}</span></span>
                    </div>

                    <div class="basket-item-price-current" style="display:none;">
							<span class="basket-item-price-current-text" id="basket-item-price-{{ID}}">
								{{{PRICE_FORMATED}}}
							</span>
                    </div>

                    <div class="basket-item-price-title" style="display:none;">
        ...
        <td class="basket-items-list-item-amount">
            ...
            <div class="basket-item-block-amount{{#NOT_AVAILABLE}} disabled{{/NOT_AVAILABLE}}" data-entity="basket-item-quantity-block">
                <span class="basket-item-amount-btn-minus {{MINUS_DISABLE}}" data-entity="basket-item-quantity-minus"></span>
                ...
                <span class="basket-item-amount-btn-plus {{PLUS_DISABLE}}" data-entity="basket-item-quantity-plus" data-max="{{CURRENT_STORE_AMOUNT}}"></span>
            ...
            {{/DELAYED}}
            {{#DELAYED}}
            <div class="basket-item-restore-actions">
                <a href="javascript:void(0)" class="basket-item-restore-btn" data-entity="basket-item-remove-delayed">Добавить</a>
            </div>
            {{/DELAYED}}
        </td>
        <?
