...
$APPLICATION->SetPageProperty("title", "Каталог детейлинг-магазина Sappo.ru");
$APPLICATION->SetPageProperty("description", "Каталог товаров для детейлинга автомобиля интернет-магазина Sappo.ru ✅ Доставка по Москве, СПб и всей России. ✅Оригинальная продукция, сертификаты на все товары.");
