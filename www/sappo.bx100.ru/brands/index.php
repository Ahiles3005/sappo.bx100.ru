...
$APPLICATION->SetPageProperty("title", "Автохимия и автокосметика по брендам в интернет-магазине Sappo.ru");
$APPLICATION->SetPageProperty("description", "Бренды товаров автохимии и автокосметики для детейлинга в интернет-магазине Sappo.ru");
...
?><?$APPLICATION->IncludeComponent(
    ...
    array(
        ...
        "T_REVIEWS" => "",
        "T_DOCS" => "Сертификаты и документы",
        "T_PROJECTS" => "",
        ...
        "T_GOODS" => "Товары #BRAND_NAME# в нашем магазине Sappo",
        "T_GALLERY" => "Галерея",
        "SHOW_GALLERY" => "Y",
        ...
        "IBLOCK_LINK_SERVICES_ID" => "38",
        "IBLOCK_LINK_TIZERS_ID" => "26",
        "IBLOCK_LINK_REVIEWS_ID" => "35",
        "IBLOCK_LINK_STAFF_ID" => "32",
        "IBLOCK_LINK_VACANCY_ID" => "18",
        "IBLOCK_LINK_BLOG_ID" => "33",
        "IBLOCK_LINK_PROJECTS_ID" => "31",
        "IBLOCK_LINK_BRANDS_ID" => "46",
        ...
        "DETAIL_BLOCKS_ALL_ORDER" => "desc,tizers,char,docs_brand,services,news,vacancy,blog,projects,brands,staff,gallery,partners,form_order,landings,goods_sections,reviews,goods,goods_catalog,comments",
